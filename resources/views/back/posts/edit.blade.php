...
@push('title', '"' . $post->meta_title . '" ' . __('Düzenle'))
@section('content')
                    ...
                    <form action="{{ route('admin.posts.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input name="slug" placeholder="{{ __('Ad-a göre otomatik oluşturulur') }}"
                                        type="text" class="form-control" required value="{{ old('slug', $post->slug) }}"
                                        maxlength="255">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="metatitle" name="meta_title"
                                        placeholder="{{ __('Ad-a göre otomatik oluşturulur') }}" type="text"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="metadescription" placeholder="{{ __('Meta Description') }}" name="meta_desc"
                                rows="3">{{ old('meta_desc', $post->meta_desc) }}</textarea>
                        </div>
                        <div class="mb-3">
                            <div class="border-dashed py-4 text-center">
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    <img src="{{ asset($post->img) }}" alt="{{ __('Post Image') }}" id="image-preview"
